...
std::string Enumerate256Colors()
{
	...
	for( unsigned short r = 0; r < 6; ++r )
	{
		for( unsigned short g = 0; g < 6; ++g )
		{
			for( unsigned short b = 0; b < 6; ++b )
				rainbow << ColorCombination( Color256(r,g,b), Color256(r,g,b) ) << " x ";
		}
	...
	for( unsigned short r = 0; r < 6; ++r )
		rainbow << ColorCombination( Color256(r,0,0), Color256(r,0,0) ) << " x ";

	for( unsigned short g = 0; g < 6; ++g )
		rainbow << ColorCombination( Color256(0,g,0), Color256(0,g,0) ) << " x ";
	
	for( unsigned short b = 0; b < 6; ++b )
		rainbow << ColorCombination( Color256(0,0,b), Color256(0,0,b) ) << " x ";
